...
function Messi(e,t){
	...
	if(n.options.title==null){
		...
		if(n.options.titleClass!=null)
			jQuery(".messi-titlebox",this.messi).addClass(n.options.titleClass)
		}
		if(n.options.width!=null)
			...
			if(n.options.buttons.length>0){
				for(var i=0;i<n.options.buttons.length;i++){
					...
					o.bind("click",function(){var e=jQuery.data(this,"value");
					var t=n.options.callback!=null?function(){n.options.callback(e)}:null;
					n.hide(t)});
